...
import { UserTransform } from '../transformers/user.transform';
...
export default class UserController
{
    ...
    async list(req: Request, res: Response)
    {
        ...
        return await this.responder.paginate(paginator, req, res, StatusCode.HTTP_OK, new UserTransform());
    }
    ...
    async save(req: Request, res: Response)
    {
        ...
        return await this.responder.send(data, req, res, StatusCode.HTTP_CREATED, new UserTransform());
    }
